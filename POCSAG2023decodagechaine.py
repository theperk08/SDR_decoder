...
def enregistre_fichier(chaine, date1, liste_config):
    fichier = open(liste_config[1] + liste_config[2] + str(date1) + ".html","a")
    fichier.write(chaine)
    fichier.close()
    
def decodagepocsag(chaine, idle, rb3, liste_config):
    #recherche d'en tête
    #puis de idle
    ...
    if rb3.GetSelection() == 2:
        ...
        enregistre_fichier(st2, date1, liste_config)
